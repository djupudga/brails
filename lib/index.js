...
const cli = meow(`
  ...
  Description:
    ...
    Brails can be configured using a config file. All non-abbreviated flags
    can be used, i.e. 'engine' but not 'e'.
  ...
  Config file format:
    The '.brailsrc.json' is a JSON file with a single property: 'engine'.
